...
//        newsDataForDown = MainActivity.SportsNews.slice(Constants.TOP_HEADLINES_COUNT until MainActivity.TechNews.size - Constants.TOP_HEADLINES_COUNT)
        adapter = NewsAdapter()
        recyclerView.adapter = adapter
        adapter.differ.submitList(MainActivity.SportsNews)
